...
def validate_autogenerated_pages(
    ...
    existing_pages_titles = {page.title: page for page in existing_pages.results}

    pages_without_label = []

    for page in pages_to_upload:
        if page.title in existing_pages_titles:
            existing_page = existing_pages_titles[page.title]
